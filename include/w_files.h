 ...
 */
#define W_FILES_MAX_DATA   (8*1024) // 8 KB
...
/**
 * @brief Инициализация модуля. Регистрирует приём на канале W_CHAN_FILES.
 * Рекомендуется вызывать в самом начале работы, до использования остальных функций.
 */
